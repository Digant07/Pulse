      ...
      <div className="modal-card docs-modal" onClick={(e) => e.stopPropagation()}>
        <header className="modal-header">
          <div className="modal-title-group">
            ...
            <h2 className="modal-title">Pluse Documentation</h2>
          </div>
        ...
        <div className="modal-body docs-body">
          <section className="docs-section">
            ...
            <p>
              Pluse is a next-generation platform for deploying web applications instantly. Follow these steps to set up your first deployment:
            </p>
          ...
          <section className="docs-section">
            ...
            <p>
              When you select a repository, Pluse scans your project's <code>package.json</code> file to detect dependencies and configure default settings:
            </p>
          ...
          <section className="docs-section">
            ...
            <p>
              Securely inject environment variables into your build environment. Pluse encrypts your variables and securely loads them during build pipeline tasks:
            </p>
          ...
          <section className="docs-section">
            ...
            <p>
              Once you hit deploy, Pluse initiates a four-stage deployment flow:
            </p>
            ...
            <p style={{ marginTop: '12px' }}>
              Logs are streamed in real time via <strong>Server-Sent Events (SSE)</strong>. If a build completes successfully, a unique routing URL (e.g., <code>https://project-name.pluse.dev</code>) is generated.
            </p>
          </section>
        </div>
